...
const generarBody = (datos) => {
    ...
    <table class="table table-striped" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 200%; max-width: 100%;">
      <thead>
        <tr>
   ...
   `
    for (const data of datos) {
       ...
       <th style="line-height: 24px; font-size: 16px; margin: 0;" align="left">${Number++}</th>
       <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="right" valign="top"><img style="width: 50px; height: 50px; object-fit: contain;" src="${data.equipo.imagen}"></td>
       <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="right" valign="top">${data.equipo.nombre}</td>
       ...
       <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="right" valign="top">${data.partidos_perdidos}</td>
       <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="right" valign="top">${data.goles_a_favor}</td>
       <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="right" valign="top">${data.goles_en_contra}</td>
...
exports.generadorTablaLiga = (datos) => {
    ...
    generarBody(datos);
    Number = 1;
    return pdf.createAsync(content, { filename: `./utils/pdf/Reporte Tabla Liga ${today}.pdf` })
}